...
class RestaurantController {
  ...
  [LOAD_RESTAURANT_OBJECTS]() {
    const category1 = this[MODEL].createCategory(
      "Hamburguesas",
      "Mejores hamburguesas para todos los gustos"
    );
    const category2 = this[MODEL].createCategory(
      "Pizzas",
      "Pizzas de todos los sabores"
    );
    const category3 = this[MODEL].createCategory(
      "Baguettes",
      "Baguettes para todo el mundo"
    );
    ...
    const dish1 = this[MODEL].createDish(
      "Pizza jamón",
      "Pizza mediana de jamón york - 5€",
      ["Jamón York", "Pan", "Queso"],
      "img/pizza1.jpg"
    );
    const dish2 = this[MODEL].createDish(
      "Pizza bacon",
      "Pizza mediana de bacon y cebolla - 6€",
      ["Bacon", "Cebolla", "Pan", "Queso"],
      "img/pizza2.jpg"
    );
    const dish3 = this[MODEL].createDish(
      "Pizza Ternera",
      "Pizza mediana de ternera y cebolla - 6,5€",
      ["Ternera", "Cebolla", "Pan", "Queso"],
      "img/pizza3.jpg"
    );
    const dish4 = this[MODEL].createDish(
      "Hamburguesa doble",
      "Hamburguesa con doble carne - 4,5€",
      ["Ternera", "Pan", "Queso", "Cebolla"],
      "img/burger1.png"
    );
    const dish5 = this[MODEL].createDish(
      "Hamburguesa huevo",
      "Hamburguesa con huevo - 4€",
      ["Ternera", "Pan", "Huevo", "Cebolla"],
      "img/burger2.jpg"
    );
    const dish6 = this[MODEL].createDish(
      "Hamburguesa completa",
      "Hamburguesa ingredientes varios - 5,5€",
      ["Ternera", "Tomate", "Pan", "Queso", "Cebolla", "Huevo"],
      "img/burger3.jpg"
    );
    const dish7 = this[MODEL].createDish(
      "Baguette vegetal",
      "Baguette hecha de vegetales - 3€",
      ["Lechuga", "Tomate", "Maíz", "Pan", "Queso"],
      "img/baguette1.jpg"
    );
    const dish8 = this[MODEL].createDish(
      "Baguette bacon queso",
      "Baguette bacon/queso - 4€",
      ["Pan", "Bacon", "Queso"],
      "img/baguette2.jpg"
    );
    const dish9 = this[MODEL].createDish(
      "Baguette calamares",
      "Baguette de calamares - 4€",
      ["Pan", "Calamares", "Queso"],
      "img/baguette3.jpg"
    );
    const dish10 = this[MODEL].createDish(
      "Pizza 4 Quesos",
      "Pizza mediana de 4 quesos distintos - 6€",
      ["Pan", "Queso"],
      "img/pizza4.jpg"
    );
    const dish11 = this[MODEL].createDish(
      "Hamburguesa ciervo",
      "Hamburguesa con carne de ciervo - 5,5€",
      ["Carne de ciervo", "Pan", "Queso", "Cebolla"],
      "img/burger4.jpg"
    );
    const dish12 = this[MODEL].createDish(
      "Baguette lomo",
      "Baguette de lomo a la plancha - 4€",
      ["Tomate", "Lomo", "Pan", "Queso"],
      "img/baguette4.jpg"
    );
    ...
    const menu1 = this[MODEL].createMenu(
      "PizzaAndFriends",
      "Pizzas escogidas para compartir en grupo"
    );
    const menu2 = this[MODEL].createMenu(
      "Burger4all",
      "Pizzas escodigas para compartir en grupo"
    );
    const menu3 = this[MODEL].createMenu(
      "PizzaBurger everywhere",
      "Mezcla de pizzas y hamburguesas para los grupos"
    );
    ...
    const rest3 = this[MODEL].createRestaurant(
      "Baguetterant",
      "Baguettes de todos los sabores",
      loc3
    );
